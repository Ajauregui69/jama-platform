...
var primary = localStorage.getItem('primary_color') || '#222AC3';
...
export const onlineDashboard = {
    ...
    options1: {
        ...
        colors: ["var(--theme-deafult)", "#F47DEA", "#FFA941", "#FFC200", "#54BA4A", "#3DA831",
            "#57B9F6", "#FF3377", "#773ACE", "#945CFF", "#222AC3"
        ],
        stroke: {
            width: 1.5,
            curve: 'smooth'
...
export const chart = {
    ...
    chart6: {
        options: {
            ...
            colors: [secondary, primary, '#51bb25', '#39539E'],
            labels: ["Skill 01", 'Skill 02', 'Skill 03', 'Skill 03'],
            plotOptions: {
                radialBar: {
                    size: undefined,
                    inverseOrder: false,
