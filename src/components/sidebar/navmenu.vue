        ...
        :class="
          ({
            ...
            hoverd:
              ...
              this.layoutobject.split(' ').includes('horizontal-wrapper'),
          },
      ...
      >
        ...
        >
          <svg class="stroke-icon">
            <use :xlink:href="getIconUrl(menuItem.icon)"></use>
          </svg>
          <svg class="fill-icon">
            <use :xlink:href="getIconUrl(menuItem.iconf)"></use>
          </svg>
          <span class="lan-3">
            {{ menuItem.title }}
          </span>
        ...
        <router-link
          ...
          :class="{ active: menuItem.path === $route.meta.parent }"
        ...
        >
          <li v-for="(childrenItem, index) in menuItem.children" :key="index">
            ...
            <router-link
              class="lan-4"
              :class="{ active: childrenItem.path === $route.meta.parent }"
